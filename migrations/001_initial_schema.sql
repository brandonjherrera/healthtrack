...
-- ============================================================================
-- SEED DATA — Default user and initial goals
-- Replace email/name with actual values before running.
-- ============================================================================
...
-- Set initial daily goals (adjust these to your actual targets)
INSERT INTO daily_goals (user_id, effective_date, calories_target, protein_g_target, carbs_g_target, fat_g_target, fiber_g_target, notes)
SELECT 
    id,
    '2026-06-01'::date,    -- effective when you start using the app
    2500,                   -- calories — adjust to your TDEE/goals
    200.0,                  -- protein (g) — high for muscle building
    250.0,                  -- carbs (g)
    80.0,                   -- fat (g)
    30.0,                   -- fiber (g)
    'Initial targets — getting back into lifting, clean bulk'
FROM users
WHERE email = 'brandon@example.com';
